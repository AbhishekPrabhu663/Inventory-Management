...
public class StoreMaterialController {
  ...
  @GetMapping("get/{storeId}/{id}")
  public Optional<StoreMaterial>getMaterialdetails(@PathVariable String storeId, @PathVariable int id){
    return storeMaterialService.getMaterialdetails(storeId,id);
  }

  @PutMapping("update/{storeId}/{id}")
public List<StoreMaterial> inwardMaterial(@PathVariable String storeId, @PathVariable int id, @RequestBody StoreMaterial updatedMaterial) {
    return storeMaterialService.inwardMaterial(storeId, id, updatedMaterial);
}
